...
if __name__ == "__main__":
    # Arguments
    parser = argparse.ArgumentParser(prog='HookPhish.py', description='A Python script designed to aid in the detection of phishing websites.', epilog='Ping me: iahmedelhabashy@gmail.com')
